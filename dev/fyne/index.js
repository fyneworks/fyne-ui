...
console.log('fyne.js process.env', process.env)
  
//import 'requestidlecallback-polyfill';

//const post = (args) => { console.log('fyne post', args) }
...
export const fwxfrm = {
    ...
    // exposing this will bundle all fyneworks network funcs
    //post:submit,
};

// bind to global fwx object
window.fwx = window.fwx || {};
window.fwx.fwxfrm = fwxfrm;
