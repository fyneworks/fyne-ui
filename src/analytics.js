...
const fwxcms_analytics = (override_options) => {
    ...
    //console.log('utm-loader fwxcms_analytics > fwxcms_analytics', options);
    ...
    const getCookie = (name) => {
        //console.log('utm-loader fwxcms_analytics > getCookie', {name});
        var value = '; ' + document.cookie;
        var parts = value.split('; ' + name + '=');
        if (parts.length == 2) return parts.pop().split(';').shift();
    };
    const setCookie = (name, value, days) => {
        //console.log('utm-loader fwxcms_analytics > setCookie', {name, value, days});
        var date = new Date();
    ...
    const getParam = (name) => {
        //console.log('utm-loader fwxcms_analytics > getParam', {name});
        name = name.replace(/[\[]/, '\\[').replace(/[\]]/, '\\]');
        var regex = new RegExp('[\\?&]' + name + '=([^&#]*)');
        var results = regex.exec(location.search);
        var output = (results === null ? '' : decodeURIComponent(results[1].replace(/\+/g, ' ')));
        //console.log('utm-loader fwxcms_analytics > getParam', {name,regex,results,output});
        return output;
    };
    ...
    const parseAnalyticsCookie = function() {
        ...
        //console.log('utm-loader fwxcms_analytics > parseAnalyticsCookie', {values});
    ...
    */
    ...
    const encode = (data) => {
        //console.log('utm-loader fwxcms_analytics > encode', {data});
        if(data && typeof(data)!='string'){
            data = JSON.stringify(data);
            //console.log('utm-loader fwxcms_analytics > encode json string', {data});
        };
        if(data && btoa && typeof(btoa)=='function'){
            data = btoa(data);
            //console.log('utm-loader fwxcms_analytics > encode base64 encoded', {data});
        };
        //console.log('utm-loader fwxcms_analytics > encode done', {data});
        return data;
    };
    const decode = (data) => {
        //console.log('utm-loader fwxcms_analytics > decode', {data});
        if(data && typeof(data)=='string' && atob && typeof(atob)=='function'){
            data = atob(data);
            //console.log('utm-loader fwxcms_analytics > decoded base64', {data});
        };
        if(data && typeof(data)=='string'){
            data = JSON.parse(data);
            //console.log('utm-loader fwxcms_analytics > parsed json string', {data});
        };
        //console.log('utm-loader fwxcms_analytics > decode done', {data});
        return data;
    };
    ...
    const enhance_analytics = (data) => {
        ...
        return new Promise( (resolve, reject)=>{
            ...
            //console.log('utm-loader enhance_analytics ------------------------', data);

            // if already enhanced, nothing else to do
            if(!!data.enhanced){
                //console.log('utm-loader enhance_analytics - already enhanced', data);
            ...
            // if no referrer, nothing else to do
                ...
                //console.log('utm-loader enhance_analytics - no ref', data);

                // we're done, there's nothing else to enhance
                data.enhanced = true;

                if(!!data.gclid){
                    //console.log('utm-loader enhance_analytics - no referer', data);
            ...
            // if referrer, parse!
                ...
                //console.log('utm-loader enhance_analytics - parse ref with refparser service', data);
                ...
                //console.log('utm-loader enhance_analytics - refparser', data);
                fetch(
                    ...
                    .then( x=> x && x.result )
                    .then( result=>{
                        //console.log('utm-loader enhance_analytics - refparser result', {data,result});
                        ...
                        if(result){
                            ...
                            //console.log('utm-loader enhance_analytics - refparser enhanced!', {data,result});

                            // only enrich with this extra info if referrer is known
                            if(result.known==true){
                                //console.log('utm-loader enhance_analytics - refparser known referrer!');
                                ...
                                if(result.medium=='search'){
                                    //console.log('utm-loader enhance_analytics - refparser known referrer - search');
                                    ...
                                    //console.log('utm-loader enhance_analytics - refparser known referrer - social');
                                    data.utm_social_network = data.utm_source;
                                    data.utm_channel = 'Social';
                                }
                                else if(result.medium=='email'){
                                    //console.log('utm-loader enhance_analytics - refparser known referrer - email');
                                ...
                                //console.log('utm-loader enhance_analytics - refparser unknown referrer');

                            }

                            //console.log('utm-loader enhance_analytics - refparser result SET', {data,result});
                            ...
                            //console.log('utm-loader enhance_analytics - refparser unknown result', {data,result});
                        }


                        //console.log('utm-loader enhance_analytics - refparser result RESOLVE', {data,result});
                    ...
                    .catch( e=> {
                        //console.log('utm-loader enhance_analytics - refparser error', result);
    ...
    const get_params = () => {
        //console.log('utm-loader fwxcms_analytics > get_params...');
        var data = {};
        ...
        //console.log('utm-loader fwxcms_analytics > get_params data', data);
        return data;
    };
    // IMPLEMENTTATION - get parameters from cookies
    const get_cookies = () => {
        //console.log('utm-loader fwxcms_analytics > get_cookies...');
        var data = {};
        options.params.forEach( p=> {
            var v = getCookie(p);
            if(v) data[p]=v;
        });
        //console.log('utm-loader fwxcms_analytics > get_cookies data', data);
        return data;
    };
    // IMPLEMENTTATION - retrieve parameters from storage
    const get_storage = () => {
        //console.log('utm-loader fwxcms_analytics > get_storage...');
        ...
        //console.log('utm-loader fwxcms_analytics > get_storage data', {data,rawdata,payload,curDate,isFresh});
        return data;
    };
    ...
    const get = () => {
        //console.log('utm-loader fwxcms_analytics > get...');
        const storage = get_storage();
        const cookies = get_cookies();
        const params = get_params();
        const data = Object.assign({}, storage, cookies, params);
        //console.log('utm-loader fwxcms_analytics > get done', {storage,cookies,params, output:data});
        return data;
    };
    // IMPLEMENTTATION - store parameters in browser for future use
    const set = (data) => {
        //console.log('utm-loader fwxcms_analytics > set...');
        set_cookies(data);
        set_storage(data);
        //console.log('utm-loader fwxcms_analytics > set done', {data});
    };
    // IMPLEMENTTATION - store parameters in browser for future use
    const bind = (data) => {
        //console.log('utm-loader fwxcms_analytics > bind...');

        // always default to internal method to get payload
        if(!data) data = Object.assign({}, get());

        //console.log('utm-loader fwxcms_analytics > bind... GO! ONE TIME');

        enhance_analytics(data).then(data=>{

            //console.log('utm-loader fwxcms_analytics > bind... GO! ONE TIME data', {data});

            //console.log('utm-loader fwxcms_analytics > bind... GO! ONE TIME data > bind_to_forms', {data});
            bind_to_forms(data);
        })

        //console.log('utm-loader fwxcms_analytics > bind done', {data});
    };
    ...
    const set_cookies = (data) => {
        //console.log('utm-loader fwxcms_analytics > set_cookies', {data});
        var cata = {};
        options.params.forEach(p=>{
            if(!data[p]) return;
    ...
    const set_storage = (data) => {
        //console.log('utm-loader fwxcms_analytics > set_storage', {data});
    ...
    const bind_to_forms = (data) => {
        //console.log('utm-loader fwxcms_analytics > bind_to_forms', {data});

        // quit if we don't want to bind parameters to forms
        if(!data || !options.params) return;

        // remove existing parameters from all forms
        //console.log('utm-loader fwxcms_analytics > bind_to_forms', 'remove existing tokens from all forms');
        options.params.forEach(p=>{
            [...document.getElementsByName(p)].forEach((x) => x.remove());
        });

        //console.log('utm-loader fwxcms_analytics > bind_to_forms invoking enhance_analytics', {data});

        // enhance analytics, parse referer, etc...
        enhance_analytics(data).then(data=>{

            //console.log('utm-loader fwxcms_analytics > bind_to_forms > enhance_analytics > result', {data});

            // add new parameters to all forms
            //console.log('utm-loader fwxcms_analytics > bind_to_forms', 'add new token to all forms');
    ...
    const watch = () => {
        //console.log('utm-loader lazybind watch');
        const events = ["click","touch","scroll","focus","focusin","focusout","mousemove"];
        const load = e => {
            //console.log('utm-loader lazybind', 'e.target',e.target, {e});
            ...
            if (e.type=='click' || e.type=='touch' || e.type=='scroll' || (e.target && e.target.matches && e.target.matches("form,input,select,textarea,label"))){
                //console.log('utm-loader lazybind start', e.type, e.target, {e});

                // remove all listeners, only run this once
                events.forEach( event => document.removeEventListener(event, load));

                // one time only!!!
                //console.log('utm-loader lazybind watch resolved, ONE TIME');
